...
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (1, 'SQL pour les nuls', 'Taylor', 'informatique', 'Book', 200,  null, null, null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (2, 'SQL pour les non nuls', 'Eyrolles', 'informatique', 'Book', 2000, null, null, null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (3, 'SQL pour les gens ni nuls ni non nuls', 'Dunod', 'informatique', 'Book', 8001, null, null, null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (4, 'Reussir a coder les yeux fermes', 'Laffont', 'informatique', 'Book', 42, null, null, null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (5, 'Programmer en Java', 'Dunod', 'informatique', 'Book', 503, null, null, null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (6, 'Seance de remise en forme', 'DupondEtDupont', 'sport', 'CD', null, 30, null, 8);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (7, 'Conception des echecs version sorcier', 'Dunod', 'informatique', 'CD', null, 90, null, 127);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (8, 'Les lois universelles de la physique', 'Eyrolles', 'physique', 'CD', null, 180, null, 321);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (9, 'Un et un font deux', 'Dunod', 'mathematiques', 'CD', null, 3600, null, 4500);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (10, 'La geometrie des espaces', 'Laffont', 'mathematiques', 'CD', null, 127, null, 129);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (11, 'La compilation des programmes', 'Dunod', 'informatique', 'DVD', null, 252, null, null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (12, 'Reviser la programmation orientee objet', 'Eyrolles', 'informatique', 'DVD', null, 31252, null, null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (13, 'Elon Musk in space', 'DupondEtDupont', 'anglais', 'DVD', null, 75, null, null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (14, 'Brian is in the kitchen', 'DupondEtDupont', 'anglais', 'DVD', null, 83, null, null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (15, 'Apprendre Symfony en 150 minutes', 'Dunod', 'informatique', 'DVD', null, 151, null, null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (16, 'Premiers pas en informatique', 'Laffont', 'informatique', 'Video', null, 15, 'MP4', null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (17, 'Tout savoir sur la physique quantique', 'Eyrolles', 'physique', 'Video', null, 2, 'AVI', null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (18, 'Les etoiles de Thomas Pesquet', 'Laffont', 'physique', 'Video', null, 65, 'FLV', null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (19, 'Les logiciels pour Mac', 'Dunod', 'informatique', 'Video', null, 3, 'WMV', null);
INSERT INTO Document (reference, title, editor, theme, category, pages, time, format, nbSubtitles) VALUES (20, 'Linux contre Windows', 'Eyrolles', 'informatique', 'Video', null, 76, 'MOV', null);
...
INSERT INTO DocumentKeywords (reference, keyword) VALUES (2, 'educational');
...
INSERT INTO DocumentKeywords (reference, keyword) VALUES (4, 'SQL');
...
INSERT INTO Copy (id, aisleID, reference) VALUES (21, 4, 20);
...
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (3, 12, to_date('2021-01-01', 'YYYY-MM-DD'), to_date('2021-01-03', 'YYYY-MM-DD'));
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (5, 13, to_date('2020-12-13', 'YYYY-MM-DD'), to_date('2020-12-16', 'YYYY-MM-DD'));
