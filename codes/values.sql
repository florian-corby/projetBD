...
INSERT INTO Author (id, name, fst_name, address, birth) VALUES (1, 'Taylor', 'Allen', '1 impasse Swift 86000 Poitiers', 1975-02-25);
INSERT INTO Author (id, name, fst_name, address, birth) VALUES(2, 'Legendre', 'Florian', '2 avenue des Gorons 69000 Lyon', 1265-07-15);
INSERT INTO Author (id, name, fst_name, address, birth) VALUES (3, 'Berthelot', 'Yann', '3 strada italiana 00144 Rome', 2000-12-12);
INSERT INTO Author (id, name, fst_name, address, birth) VALUES (4, 'Fradet', 'Amandine', '4 chemin des chemins 31000 Toulouse', 1995-09-26);
INSERT INTO Author (id, name, fst_name, address, birth) VALUES (5, 'Pelle', 'Sarah', '16 rue de la vieille 34000 Montpellier', 1965-06-04);
INSERT INTO Author (id, name, fst_name, address, birth) VALUES (6, 'Ere', 'Axel', '43 Place au beurre 29000 Quimper', 1972-11-11);
INSERT INTO Author (id, name, fst_name, address, birth) VALUES (7, 'Glace', 'Brice', 'rue du chat qui peche 75000 Paris', 1982-09-24);
INSERT INTO Author (id, name, fst_name, address, birth) VALUES (8, 'Cepacare', 'Ciceron', 'impasse de la these 13000 Marseille', 1999-01-01);
INSERT INTO Author (id, name, fst_name, address, birth) VALUES (9, 'Guetta', 'David', 'rue de la pie qui boit 35400 Saint-Malo', 1998-03-05);
INSERT INTO Author (id, name, fst_name, address, birth) VALUES (10, 'Fer', 'Lucie', '6 rue des enfers 72650 Saint-Saturnin', 1969-06-16);
...
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (1, 1, 2018-11-16, 2018-11-19);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (1, 15, 2019-03-03, 2019-03-05);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (2, 11, 2021-04-24, 2020-04-27);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (3, 12, 2021-01-01, 2020-01-03);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (5, 13, 2020-12-13, 2019-12-16);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (15, 14, 2021-03-31, 2021-04-03);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (12, 1, 2020-04-21, 2020-04-30);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (12, 6, 2020-04-21, 2020-04-26);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (12, 11, 2020-04-21, 2020-04-25);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (12, 16, 2020-04-21, 2020-04-24);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (2, 2, 2021-02-12, 2021-02-23);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (2, 7, 2021-02-12, 2021-02-16);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (2, 11, 2021-02-12, 2021-02-15);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (2, 17, 2021-02-12, 2021-02-14);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (11, 3, 2019-07-07, 2019-07-10);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (11, 8, 2019-07-07, 2019-07-10);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (11, 11, 2019-07-07, 2019-07-09);
INSERT INTO Borrow (borrower, copy, borrowing_date, return_date) VALUES (11, 18, 2019-07-10, 2019-07-11);
